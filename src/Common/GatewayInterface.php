 ...
 * @method \Omnipay\Common\Message\RequestInterface createCustomer(array $options = array())              (Optional method)
 *         The returned response object includes a customerReference, which can be used for future transactions
 * @method \Omnipay\Common\Message\RequestInterface updateCustomer(array $options = array())              (Optional method)
 *         Update a stored customer
 * @method \Omnipay\Common\Message\RequestInterface deleteCustomer(array $options = array())              (Optional method)
 *         Delete a stored customer
 */
